...
function Icon(props: SVGProps<SVGSVGElement>) {
  return <svg {...defaults} {...props} />;
}

/** Matches payout toolbar icon style (stroke icons). */
export function IconPayoutCalculator(props: SVGProps<SVGSVGElement>) {
  return (
    <Icon {...props}>
...
export function IconSidePot(props: SVGProps<SVGSVGElement>) {
  return (
    <Icon {...props}>
